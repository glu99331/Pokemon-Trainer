...
if __name__ == "__main__":
    ...
    memory = SequentialMemory(NB_TRAINING_STEPS, window_length=1)
    ...
    env_player.play_against(
        ...
        opponent=opponent,
        env_algorithm_kwargs={"dqn": dqn, "nb_steps": NB_TRAINING_STEPS,  "rewards_callback": [rewards_callback]},
    )
    print(rewards_callback.episode_rewards)
    ...
    plt.plot(rewards_callback.episode_rewards)
